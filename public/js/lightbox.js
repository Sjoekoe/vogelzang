var ssdLight = {
	...
	containerLightBox : '<div id="lightbox"><div id="lightbox-wrapper"><div id="lightbox-content"></div><div id="lightbox-tools" class="clearfix"><span id="lightbox-prev"><span class="glyphicon glyphicon-arrow-left"></span></span><span id="lightbox-next"><span class="glyphicon glyphicon-arrow-right"></span></span></div></div></div>',
	run : function(obj) {
		...
		imgObject.onload = function() {
			...
			var posTop = (windowHeight/2)-((ssdLight.imgHeight + ssdLight.imgPaddingVer ) / 2);
			var posLeft = (windowWidth/2)-((ssdLight.imgWidth + ssdLight.imgPaddingHor) / 2);
			
			$('#lightbox').hide().css({
				'top' : posTop + 'px',
				'left' : posLeft + 'px',
				'width' : (ssdLight.imgWidth + ssdLight.imgPaddingVer) + 'px',
				'height' : (ssdLight.imgHeight  + ssdLight.imgPaddingHor) + 'px'
			}).fadeIn(500);
