...
@section('content')
	...
	<div class="col-md-8 col-md-offset-1 truecontent">
		...
		{{ Form::model($item, array('files' => 'true', 'role' => 'form', 'class' => 'form-horizontal', 'method' => 'patch', 'route' => array('items.update', $item->id))) }}
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<div class="thumbnail">
							...
							<p> <a href=" {{ URL::route('itemphoto.destroy', $item->itemphoto->id) }} "> <span class="glyphicon glyphicon-trash"></span> </a> </p>
						</div>
					</div>	
				</div>				
			@endif
		...
		<div class="bordertop overview">
			...
			<a href=" {{ URL::route('items.admin.show', $item->id) }} "> <span class="glyphicon glyphicon-eye-open"></span> Bekijken </a> - 
