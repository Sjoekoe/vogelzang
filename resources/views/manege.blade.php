                ...
                <div class="col-md-8 col-sm-12 rightborder rbshow">
                    ...
                    <div class="col-md-6 col-sm-6 nopadright leftborder">
                        ...
                        <ul class="accomodation">
                            ...
                            <li>04 Juli - 08 Juli</li>
                            <li>12 Juli - 15 Juli (Sportdienst Lokeren)</li>
                            <li>18 Juli - 22 Juli</li>
                            <li>08 Augustus - 12 Augustus</li>
                            <li>18 Augustus - 19 Augustus</li>
                            <li>22 Augustus - 26 Augustus (Sportdienst Lokeren)</li>
                        </ul>
                    </div>
                </div>
