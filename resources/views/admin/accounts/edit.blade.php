...
@section('content')
	...
	<div class="col-md-8 col-md-offset-1 truecontent">
		...
		<div class="overview bordertop">
			<a href=" {{ route('accounts.index') }} "> <span class="glyphicon glyphicon-th-list"></span> Terug naar overzicht </a> -
			<a href=" {{ route('accounts.show', $user->id) }} "> <span class="glyphicon glyphicon-eye-open"></span> Bekijken </a> -
			<a href=" {{ route('accounts.destroy',$user->id) }} "> <span class="glyphicon glyphicon-trash"></span> Verwijderen </a>
		</div>
	</div>
